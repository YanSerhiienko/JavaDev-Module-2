...
class CalculatorTest {
    ...
    public void testThatMultiplyExpressionCalculatedCorrectly() {
        Expression expression = Expression.builder()
                ...
                .build();
        Assertions.assertEquals(12, calculator.calculate(expression));
    }
    ...
    public void testThatDivideExpressionCalculatedCorrectly() {
        Expression expression = Expression.builder()
                ...
                .build();
        Assertions.assertEquals(3, calculator.calculate(expression));
    }
    ...
    public void testThatIllegalArgumentExceptionThrownForInvalidInput() {
        ...
        for (Expression invalidInput : invalidInputs) {
            Assertions.assertThrows(IllegalArgumentException.class, () -> calculator.calculate(invalidInput), invalidInput + "");
        }
    }
}